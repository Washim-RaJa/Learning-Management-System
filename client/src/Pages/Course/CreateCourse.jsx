    ...
    <HomeLayout>
      <div className="flex items-center justify-center h-[100vh]">
        ...
        >
          ...
          <button className="w-full py-2 rounded-sm font-semibold text-lg bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300" type="submit">Create Course</button>
        </form>
      </div>
    </HomeLayout>
  );
